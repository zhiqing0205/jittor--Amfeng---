...
def sample_image(n_row, batches_done):
    ...
    save_image(gen_imgs.numpy(), "train_img/%d.png" % batches_done, nrow=n_row)
...
for epoch in range(opt.n_epochs):
    ...
    if epoch % 10 == 0:
        generator.save("models/generator_last.pkl")
        discriminator.save("models/discriminator_last.pkl")
